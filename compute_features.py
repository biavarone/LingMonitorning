...
def compute_features(sentences, dictionary):
    """
    Compute the features defined in the Class Features()

    :param sentences: ([[Sentence]]) list of sentences  # TODO
    :param dictionary: //
    :return: computed features (list?)  # TODO
    """
